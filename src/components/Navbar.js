        ...
        return(
            <div id="navbar">
                <div className="link-container  is-flex">
                    <NavLink to="/" className="is-size-5 is-size-6-mobile has-text-weight-bold page-link">About</NavLink>
                    <NavLink to="/projects" className="is-size-5 is-size-6-mobile has-text-weight-bold page-link">Projects</NavLink>
                    <NavLink to={pdf} target="_blank" className="is-size-5 is-size-6-mobile has-text-weight-bold page-link">Resume</NavLink>
                </div>
                <div className="icon-container is-flex">
                    <a href="https://github.com/samanthajuniper/" target="_blank" rel="noopener noreferrer" className="social-icon github">
                        <span className="icon is-large">
                            <i className="fab fa-github-square is-size-3 is-size-4-mobile"></i>
                        </span>
                    </a>
